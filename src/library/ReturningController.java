...
public class ReturningController implements Initializable {
 ...
 @FXML
    ...
    @FXML
    private Label txt_book_name;
    @FXML
    private Label txt_book_id;
    ...
    private void saveData() {
        try {
            ...
            preparedStatement.setString(3, txt_student_id.getText());
    ...
    private void ShowDetails() {
        try {
            ...
            String query = "SELECT borrows.Book_id, CONCAT(books.Title,\" - \",books.Author) as Book_name\n"
                    + "from books join borrows on borrows.Book_id=books.Book_id\n"
            ...
            while (resultset.next()) {
                String bn = resultset.getString("Book_name");
                txt_book_name.setText(bn);
                String bid = resultset.getString("Book_id");
                txt_book_id.setText(bid);
            }
